    ...
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <h4 class="m-0 display-6 font-weight-bold text-right text-primary">Punto de Venta</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <label class="col-form-label" for="iptCodigoVenta">
                                ...
                                <span class="small">Total de Productos</span>
                            </label>
                    ...
                    <div class="col-md-12">
                        ...
                        <table id="lstProductosVenta" class="display nowrap table-striped w-100 shadow ">
                            <thead class="bg-danger text-left fs-6">
                                <tr>
                                    <th>Item</th>
                                    <th>Codigo</th>
                                    <th>Id Categoria</th>
            ...
            <div class="col-md-3">
                ...
                <div class="card shadow">
                    ...
                    <h5 class="card-header py-1 bg-primary text-white text-center">
                        Total de Venta: $ <span id="totalVentaRegistrar">0.00</span>
                    </h5>
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button class="btn btn-danger btn-sm" id="btnIniciarVenta">
                                    <i class="fas fa-shopping-cart"></i> Realizar Venta
                                </button>
                            </div>
                            <div class="col-md-6 text-right">
                                <button class="btn btn-dark btn-sm" id="btnVaciarListado">
...
<script>
    ...
    function recalcularTotales(){
        ...
        var totalVenta = $("#totalVenta").html();
        var igv = parseFloat(totalVenta) * 0.16
        ...
        if (count > 0) {
            ...
            if ($("#iptEfectivoRecibido").val() > 0 && $("#iptEfectivoRecibido").val() != "") {
                ...
                table.rows().eq(0).each(function(index) {
                    ...
                    arr[index] = data['codigo_producto'] + "," + parseFloat(data['cantidad']) + "," + data['total'].replace("$ ", "");
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        window.open('http://localhost/puntoventa/vistas/generar_ticket.php?nro_boleta='+nro_boleta);
                    }
                });
