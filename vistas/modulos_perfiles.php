    ...
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <h1 class="m-0 display-6 font-weight-bold text-right text-primary">Administrar Módulos y Perfiles</h1>
            ...
            <div class="tab-pane fade active show mt-4 px-4" id="content-modulo-perfil" role="tabpanel" aria-labelledby="content-modulo-perfil-tab">
                ...
                <div class="row">
                        ...
                        <div class="card card-danger shadow">
                            ...
                            <div class="card-body">
                                ...
                                <table id="tbl_perfiles_asignar" class="display nowrap table-striped w-100 shadow rounded">
                                    ...
                                    <thead class="bg-danger text-left">
                                        <th>id Perfil</th>
                                        <th>Perfil</th>
                                        <th>Estado</th>
                                        <th>F. Creación</th>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-danger shadow" style="display:block" id="card-modulos">
                            ...
                            <div class="card-body" id="card-body-modulos">
                                ...
                                <div class="row m-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button class="btn btn-warning btn-small m-0 p-0 w-100" id="desmarcar_modulos">Desmarcar todo</button>
                                ...
                                <div class="row m-2">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button class="btn btn-info btn-small w-50 text-center" id="asignar_modulos">Asignar</button>
