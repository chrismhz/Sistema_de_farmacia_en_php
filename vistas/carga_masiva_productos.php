...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 display-6 font-weight-bold text-right text-primary">Carga Masiva de Productos desde Excel</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-lg-12">
                <div class="card card-danger">
                    <div class="card-header">
                        <h3 class="card-title">Ingrese archivo de Carga</h3>
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" id="form_carga_productos">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <input type="submit" value="Cargar Productos de Excel" class="btn btn-success"
                                        id="btnCargar">
                                </div>
                            </div>
                        </form>
