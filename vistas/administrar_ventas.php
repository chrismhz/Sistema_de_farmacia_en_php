<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-md-6">
                <h4 class="m-0 display-6 font-weight-bold text-right text-primary">Reportes</h4>
            </div>
            <div class="col-md-6">
...
<div class="content pb-2">
    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-2 text-center">
                                <div class="form-group">
                                    <label for="">Ventas realizadas desde:</label>
                            ...
                            <div class="col-md-2 text-center">
                                <div class="form-group">
                                    <label for="">Ventas realizadas hasta:</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i class="far fa-calendar-alt"></i>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <h4>Total de venta: $ <span id="totalVenta">0.00</span></h4>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
