            ...
            for ($i=2; $i <= $numeroFilasProductos ; $i++) { 
                ...
                if(!empty($codigo_producto)){
                    if($stock_producto < 20){
                        ...
                        // La cantidad de stock es mayor o igual a 20, mostrar mensaje de error en un elemento del DOM
                        $errorMensaje = "Error: La cantidad ingresada es superior al stock disponible.";
                        echo '<script type="text/javascript">document.getElementById("mensajeError").innerText = "' . $errorMensaje . '";</script>';
    ...
    static public function mdlRegistrarProducto($codigo_producto, $id_categoria_producto,$descripcion_producto,$precio_compra_producto,
        ...
        try{
            ...
            if($stock_producto < 20){
                ...
                // La cantidad de stock es mayor o igual a 20, mostrar mensaje de error en un elemento del DOM
                $resultado = "Error: La cantidad ingresada es superior al stock disponible.";
                echo '<script type="text/javascript">document.getElementById("mensajeError").innerText = "' . $errorMensaje . '";</script>';
                // Puedes agregar código adicional si es necesario
            }
        }catch (Exception $e) {
